...
def append_run_summary(filename="atlas_runs_summary.xlsx"):
    ...
    if new_file:
        ...
        title_text = "ATLAS Traffic Run Summary"
    ...
    # Save workbook
    wb.save(filepath)
    print("[ATLAS] run summary appended to", filepath, "| runs =", total_runs, "| avg time =", avg_mmss)