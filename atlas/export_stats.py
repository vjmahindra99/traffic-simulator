...
def export_stats_to_xlsx(filename="atlas_stats.xlsx"):
    ...
    wb = Workbook()
    ws = wb.active
    ws.title = "ATLAS Stats"

    # Title
    title_text = "ATLAS Traffic Light Statistics"
    ...
    # Save workbook
    wb.save(filepath)
    print("[Adaptive] stats exported to", filepath)