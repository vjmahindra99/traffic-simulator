...
from .yolo_intergation import get_lane_density, get_lane_queue
...
def compute_density(dir_index):
    ...
    score = get_lane_density(dir_index)
    print("[density] dir = ", dir_index, "-> density = ", format(score, ".2f"))
    return score
...
# Count vehicles at stop line (YOLO queue length)
def count_near_stop(dir_index):
    return get_lane_queue(dir_index)
