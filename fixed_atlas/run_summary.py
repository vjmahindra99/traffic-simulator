...
def append_run_summary(filename="fixed_runs_summary.xlsx"):
    ...
    if new_file:
        ...
        title_text = "Fixed-time Traffic Run Summary"
    ...
    # Save workbook
    wb.save(filepath)
    print("[FIXED] run summary appended to", filepath, "| runs =", total_runs, "| avg time =", avg_mmss)